  ...
  !(function (t) {
    let i = {
        ...
        searchResultTemplate:
          '<link rel="stylesheet" href="{{ "../css/style.css" | absolute_url }}"><div class="coursecard"><div class="deptandinst"><span class="dept"> {department} </span> <br></div><div class="coursedetail"><div style="font-size:25px; color:black;" >{title}: {name}</div><div class="inst">{inst}</div></div><div class="desc">{description}</div><a href="{url}"><button type="button" class="btn btn-info knowmore" >Know more</button></a></div>',
